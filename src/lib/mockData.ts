  ...
  },
  {
    ...
    "resources": [
      ...
      },
      {
        ...
        "recovery": "manual",
        "source": "Item",
        "description": "**Description:** This staff, crafted from porous, strange wood, is topped with a glass vial where a green fluid perpetually churns. The staff has 6 charges and regains 1d6 expended charges daily at dawn.\n\n**Spells.** You can expend 1 charge to cast Melf's Acid Arrow as a 3rd-level spell from the staff (using your **spell attack bonus or +7**, whichever is higher).\n\n**Corrosive Reagents.** The acid produced by this staff is exceptionally potent. When you hit a creature with an attack roll using this staff, the acid not only deals damage but also temporarily degrades the target's defenses. The target suffers a **-1 penalty to its Armor Class** until the start of your next turn.\n\n**Volatile Core.** The alchemical mixture inside is unstable. If you roll a 1 on the d20 for a spell attack roll with this staff, the staff leaks hazardous fluids, and you take **2****d4 acid damage**.\n\n**Fragile Magic.** If you expend the last charge, roll a d20. On a 1, the glass vial shatters, the fluid evaporates, and the staff becomes a nonmagical quarterstaff."
      }
    ],
    "spellSlots": [
      {
