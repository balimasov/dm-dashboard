...
/** D&D Beyond's own mark is a bold red ampersand — reproduced as one directly instead of a drawn shape, since that *is* the logo. */
...
const REGISTRY: RegistryEntry[] = [
  { name: "D&D Beyond", match: (h) => h === "dndbeyond.com" || h.endsWith(".dndbeyond.com"), Icon: DndBeyondIcon, colorClass: "text-red-600" },
