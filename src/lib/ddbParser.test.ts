...
describe("Fighting Style feats — global attack/damage modifiers not tied to any single weapon", () => {
  ...
  test("same Fighter with every weapon/Shield unequipped — both Unarmed Strike (1d6) and Unarmed Fighting (no weapons/shield) (1d8) are unchanged, since neither is derived from currently-equipped gear", () => {
