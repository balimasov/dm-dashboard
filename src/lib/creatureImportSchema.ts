...
export const CREATURE_IMPORT_FIELDS: CreatureFieldSpec[] = [
  ...
  },
  {
    ...
    kind: "string",
    required: false,
    doc: "Довільні нотатки ДМ (необов'язково) — та сама вкладка Notes на картці істоти, що й при ручному редагуванні. Пиши звичайним Markdown, при імпорті він конвертується у форматований текст: заголовки # / ## / ### (лише ці 3 рівні), **жирний**, *курсив*, списки через дефіс \"- \" чи номер \"1. \" — кожен новий абзац відділяй порожнім рядком. Без вкладених списків, посилань чи таблиць. Залиш порожнім, якщо нотаток немає.",
    example:
