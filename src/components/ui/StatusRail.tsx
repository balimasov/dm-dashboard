 ...
 * 16px content padding where the header/text actually starts. `32px` (not
 * the even `h-8` Tailwind step, which is also 32px but reads as a
 * coincidence rather than the deliberate value this is) — shrunk 2px twice
 * now per feedback, since the rail dips down over the name/header row below
 * it and a couple fewer pixels there measurably reduces how much it crowds
 * a long name.
 */
const STATUS_BADGE_SIZE =
  "relative flex h-[32px] w-[32px] shrink-0 items-center justify-center rounded-full border-2 bg-slate-950";
