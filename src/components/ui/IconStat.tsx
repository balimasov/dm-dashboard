    ...
    <span className={`flex items-center gap-1.5 ${className}`}>
      ...
      <span className="flex min-w-0 flex-1 items-baseline gap-1">
        <InfoTooltip panel={panel}>
          {/* Same muted-label-plus-colon convention `SenseEntries`/`IconInfoList` already use for Darkvision/Resist/Immune — this row used to be the one place with a bare, brighter (inherited `text-slate-300`) label and no colon. */}
